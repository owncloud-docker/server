...
- [`10.12.0`](https://github.com/owncloud-docker/server/blob/master/v20.04/Dockerfile.amd64) available as `owncloud/server:10.12.0`, `owncloud/server:10.12`, `owncloud/server:10`
- [`10.11.0`](https://github.com/owncloud-docker/server/blob/master/v20.04/Dockerfile.amd64) available as `owncloud/server:10.11.0`, `owncloud/server:10.11`
