...
- [`10.13.3`](https://github.com/owncloud-docker/server/blob/master/v20.04/Dockerfile.multiarch) available as `owncloud/server:10.13.3`, `owncloud/server:10.13`, `owncloud/server:10`, `owncloud/server:latest`
