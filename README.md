...
- [`10.12.1`](https://github.com/owncloud-docker/server/blob/master/v20.04/Dockerfile.amd64) available as `owncloud/server:10.12.1`, `owncloud/server:10.12`, `owncloud/server:10`
